 ...
 */
class Image extends \keny\LeboncoinBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'keny\\LeboncoinBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'keny\\LeboncoinBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'keny\\LeboncoinBundle\\Entity\\Image' . "\0" . 'alt');
        }
